...
async def update_repo(_, message: Message):
    ...
    msg = await message.reply(" `المبرمج حسين`")
    ...
    if update_avail:
        ...
        return
    await msg.edit(f"المبرمج حسين [المطور](https://t.me/rcrcu)", disable_web_page_preview=True)


@Client.on_message(command(["استارت", f"restart@{BOT_USERNAME}"]) & ~filters.edited)
@sudo_users_only
